...
class CategoryFeature(models.Model):
    ...
    feature_name = models.CharField(verbose_name='Имя ключа для категории',
                                    max_length=50)
    feature_filter_name = models.CharField(verbose_name='Имя для фильтра',
                                           max_length=50)
...
class FeatureValidator(models.Model):
    ...
    category = models.ForeignKey("mainapp.Category", verbose_name='Категория',
                                 on_delete=models.CASCADE)
    feature_key = models.ForeignKey(CategoryFeature,
...
class ProductFeatures(models.Model):
    ...
    product = models.ForeignKey("mainapp.Product", verbose_name='Товар',
                                on_delete=models.CASCADE)
    feature = models.ForeignKey(CategoryFeature, verbose_name='Характеристика',
                                on_delete=models.CASCADE)
